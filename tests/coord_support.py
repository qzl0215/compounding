...
class CoordCliTestCase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        shutil.copy(ROOT / "shared" / "derived-asset-contract.ts", self.target / "shared" / "derived-asset-contract.ts")
        ...
        shutil.copy(ROOT / "kernel" / "derived-asset-contract.yaml", self.target / "kernel" / "derived-asset-contract.yaml")
        shutil.copy(ROOT / "kernel" / "task-state-machine.yaml", self.target / "kernel" / "task-state-machine.yaml")
        shutil.copy(ROOT / "schemas" / "derived-asset-contract.schema.yaml", self.target / "schemas" / "derived-asset-contract.schema.yaml")
