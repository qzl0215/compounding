...
- 文件：`AGENTS.md`、`docs/PROJECT_RULES.md`、`docs/DEV_WORKFLOW.md`、`docs/AI_OPERATING_MODEL.md`、`memory/project/current-state.md`
- 边界：关键说明文档保留人工维护，不把判断性内容错误生成化。；结构性改动时必须通过 task、memory 与相关文档同步回写。；若规则与现实冲突，先更新主源，再调整执行链路。
