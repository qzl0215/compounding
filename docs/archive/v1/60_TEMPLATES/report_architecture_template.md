---
title: report_architecture_template
...
# report_architecture_template

## Template Purpose

该模板用于 `report_architecture_template` 场景下的标准输入输出，默认服从项目汇报契约。
...
- File: `docs/60_TEMPLATES/report_architecture_template.md`
