---
title: workorder_template_plan
owner_role: Builder
status: active
last_reviewed_at: 2026-03-11
source_of_truth: bootstrap/project_bootstrap.yaml
related_docs:
  - docs/60_TEMPLATES/task_intake_template.md
  - docs/50_SOP/PLAN_EXECUTE_REVIEW_SOP.md
---

<!-- BEGIN MANAGED BLOCK: CANONICAL_CONTENT -->
# workorder_template_plan

## Template Purpose

该模板用于 `workorder_template_plan` 场景下的标准输入输出，默认服从项目汇报契约。
...
- File: `docs/60_TEMPLATES/workorder_template_plan.md`
