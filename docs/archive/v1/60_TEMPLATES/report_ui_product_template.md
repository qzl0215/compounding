---
title: report_ui_product_template
status: active
last_reviewed_at: 2026-03-11
source_of_truth: bootstrap/project_bootstrap.yaml
related_docs:
  - docs/30_STRATEGY/NORTH_STAR_AND_GOALS.md
  - docs/00_SYSTEM/PROJECT_RULES.md
---

<!-- BEGIN MANAGED BLOCK: CANONICAL_CONTENT -->
# report_ui_product_template

## Template Purpose

该模板用于 `report_ui_product_template` 场景下的标准输入输出，默认服从项目汇报契约。
...
- File: `docs/60_TEMPLATES/report_ui_product_template.md`
